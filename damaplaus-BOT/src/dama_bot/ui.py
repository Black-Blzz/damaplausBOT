...
class DamaPage:
    ...
    async def queue_tankegna(self, stake: int, odd_only: bool, control, log, min_balance: float = 10.0) -> EntryResult:
        ...
        return await join_match(
            ...
            matchmaking_selector=self.settings.selectors["tankegna_matchmaking"],
            game=GAME,
            stake=stake,
            control=control,
            odd_only=odd_only,
